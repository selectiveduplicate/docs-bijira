...
description: "Enable distributed tracing for WSO2 API Manager with OpenTelemetry, exporting trace data to Jaeger, Zipkin, a local log file, or an OTLP endpoint, or by implementing a custom tracer."
