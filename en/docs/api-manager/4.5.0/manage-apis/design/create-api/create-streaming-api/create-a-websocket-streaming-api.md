...
Once you create and publish a WebSocket API, you can also <a href="../../../../manage-apis/deploy-and-publish/deploy-on-gateway/deploy-api/deploy-an-api.md">deploy the API you created</a>.
