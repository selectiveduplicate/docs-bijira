...
products, see <a href="../../../install-and-setup/setup/security/configuring-keystores/keystore-basics/about-asymetric-cryptography.md">About Asymmetric Cryptography</a>.<br />
For information on how to create and configure your own keys and keystores, see <a href="../../../install-and-setup/setup/security/configuring-keystores/configuring-keystores-in-wso2-api-manager.md">Creating New Keystores</a>.</p></td>
</tr>
<tr class="odd">
...
<p>See <a href="../../../install-and-setup/setup/security/logins-and-passwords/working-with-encrypted-passwords.md">Encrypting Passwords in Configuration Files</a> for instructions.</p></td>
</tr>
<tr class="even">
<td><p>Change default ports</p>
<p><br />
</p></td>
<td><p>For information on all the default ports used by WSO2 API Manager, see <a href="../../../install-and-setup/setup/reference/default-product-ports.md">Default Product Ports</a>. For example, the default HTTPS port is 9443 and the HTTP port is 9763. In addition, Axis2 services are exposed over the following ports: 8243 and 8280.</p>
<p>For information on changing a default port, see <a href="../../../install-and-setup/setup/deployment-best-practices/changing-the-default-ports-with-offset.md">Changing the Default Ports with Offset</a>.</p></td>
</tr>
<tr class="odd">
...
<ul>
  <li><a href="../../../install-and-setup/setup/security/configuring-transport-level-security.md">Configuring Transport Level Security</a></li>
  <li><a href="../../../install-and-setup/setup/reference/supported-cipher-suites.md">Supported Cipher Suites</a></li>
</ul>    
...
<p>For more information, see <a href="../../../install-and-setup/setup/security/configuring-transport-level-security.md">Configuring 
...
<p>To enable HSTS please follow the instructions <a href="../../../install-and-setup/setup/deployment-best-practices/security-guidelines-for-production-deployment.md#enable-http-strict-transport-security-hsts-headers">Enable HTTP Strict Transport Security (HSTS) Headers</a>.</p>
...
<p>For instructions, see <a href="../../../install-and-setup/setup/security/enabling-hostname-verification.md">Enabling HostName Verification</a>.</p></td>
</tr>
<tr class="odd">
...
<p>For more information on how to change the password of the administrator in the API-M server, see <a href="../../../install-and-setup/setup/security/logins-and-passwords/maintaining-logins-and-passwords.md#change-the-super-admin-credentials">Changing the super admin credentials</a>.</p></td>
</tr>
<tr class="odd">
...
href="../../../install-and-setup/setup/reference/product-compatibility.md#tested-operating-systems-and-jdks">Tested Operating Systems and JDKs</a>.</p>
...
<td><p>In an API-M deployment, it is recommended to restrict outbound connections of the Control Plane node (which contains the Publisher) and only allow access to the internal nodes (only to the nodes that the Publisher portal is intended to communicate with) of the deployment. Therefore, even if a situation arises where privileged user credentials are exposed to a user with malicious intent, such users will not be able to exploit and perform any unintended network interactions.</p>
    <p>See the <a href="../../../install-and-setup/setup/deployment-overview.md">API-M deployment</a> documentation for details.</p>
</td>
</tr>
<tr class="even">
...
<p>For information on the minimum software that your WSO2 product will need, see <a href="../../../install-and-setup/install/installation-prerequisites.md#system-requirements">Installation Prerequisites</a>.</p></td>
</tr>
<tr class="odd">
...
href="../../../install-and-setup/setup/deployment-best-practices/backup-recovery.md">Backup and Recovery Recommendations</a>.</p></td>
</tr>
</tbody>
</table>
...
<p>For the full list of ports in all WSO2 products, see <a href="../../../install-and-setup/setup/reference/default-product-ports.md">Default Product Ports</a>.</p></td>
</tr>
<tr class="even">
