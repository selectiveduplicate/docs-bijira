...
The available aggregation tables in WSO2 API-M Analytics and its schema listed [here](../learn/analytics/analytics-event-streams-and-aggregations/#api-manager-aggregate-tables). 
