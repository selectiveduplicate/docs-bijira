...
- Add an API Category using the Admin REST API. (You can use the POST resource in the **API Category (Individual)** section [here](../../../../develop/product-apis/admin-apis/admin-v1/admin-v1))
