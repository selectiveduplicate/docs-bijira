...
For more details, see [Enabling Monetization of APIs-](../../learn/api-monetization/monetizing-an-api).

To view API usage and statistics, configure WSO2 API-M Analytics. For more details, see [Configuring APIM Analytics](../../learn/analytics/configuring-apim-analytics/#configuring-apim-analytics).
