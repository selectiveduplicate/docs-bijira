...
Sign in to Admin Portal (`https://<API-M_host>:<API-M_port>/admin`) as the user that you created in <a href="../../administer/managing-users-and-roles/managing-users-for-admin-portal/#step2">Step 2</a>, and use `admin`/`admin` as the credentials. 
