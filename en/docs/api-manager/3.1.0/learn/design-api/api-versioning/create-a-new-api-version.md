...
authentication mechanism, resources, [throttling tiers](../../../learn/rate-limiting/introducing-throttling-use-cases/), target audiences, etc. WSO2 does not recommend to modify a published API that has subscribers plugged into it.
...
!!! note
    ...
    [Create a REST API](../../../learn/design-api/create-api/create-a-rest-api/) section and Published in the [Publish an API](../../../learn/design-api/publish-api/publish-an-api/) section.
...
1.  Sign in to the WSO2 API Publisher.
     ...
     Create and publish an API. For more information, see [Create a REST API](../../../learn/design-api/create-api/create-a-rest-api/) and [Publish an API](../../../learn/design-api/publish-api/publish-an-api/).
...
!!! note
    For more details on the default version, see [Backward Compatibility](../../../learn/design-api/api-versioning/backward-compatibility/) section.
...
[publish the new version and deprecate old API versions](../../../learn/design-api/api-versioning/deprecate-the-old-version/).
