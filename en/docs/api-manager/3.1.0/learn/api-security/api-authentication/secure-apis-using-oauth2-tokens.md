...
OAuth 2.0 access tokens come in two different flavors
   ...
   - [JWT Access Tokens](../../../learn/api-security/oauth2/access-token-types/jwt-tokens)
    
   - [Opaque Access Tokens](../../../learn/api-security/oauth2/access-token-types/opaque-tokens)
