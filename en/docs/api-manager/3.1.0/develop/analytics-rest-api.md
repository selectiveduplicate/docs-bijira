...
The available aggregation tables in WSO2 API-M Analytics and its schema are listed [here](../learn/analytics/analyzing-apim-statistics-with-batch-analytics/introducing-the-wso2-api-manager-statistics-model/#api-manager-aggregate-tables). 
