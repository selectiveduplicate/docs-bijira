...
!!! warning
    ...
    - **[WSO2 recommends that you use the Publisher v1 REST APIs](../../../../develop/product-apis/publisher-apis/publisher-v1/publisher-v1)** as it up to date and has support for the latest WSO2 API Manager 3.1.0 features.
