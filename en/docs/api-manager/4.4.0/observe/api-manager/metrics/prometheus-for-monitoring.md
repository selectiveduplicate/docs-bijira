...
description: "Configure the Prometheus JMX exporter Java agent and a Prometheus server to scrape and visualize WSO2 API Manager's JMX-exposed statistics as Prometheus metrics."
