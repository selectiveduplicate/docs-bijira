...
description: "Design a GraphQL API in WSO2 API Manager from an SDL schema, and configure authorization, security, and rate limiting for its query, mutation, and subscription operations."
