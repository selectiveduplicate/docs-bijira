...
4.  Select the roles you want to assign to the user. In this example, we assign the `creator` role defined in the [previous section](../../administer/managing-users-and-roles/managing-user-roles.md). For details on adding roles, see [Create user roles](../../administer/managing-users-and-roles/managing-user-roles.md#create-user-roles).
...
1.  Create a user.
2.  Create a new role. For more information, see [Create User Roles](../../administer/managing-users-and-roles/managing-user-roles.md#create-user-roles).
