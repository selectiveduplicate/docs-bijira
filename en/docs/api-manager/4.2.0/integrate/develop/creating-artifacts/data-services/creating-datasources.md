...
1.  Select the already created [**Datasource Config module**](../../../../integrate/develop/create-integration-project/#datasource-project) in the project
...
2.  Select your [**datasource config module**](../../../../integrate/develop/create-integration-project/#datasource-project) as the **Container**, add the file name for your datasource, and click **Finish**.
...
!!!	Tip
    ...
    For more information, you can follow the steps given in [Generate Data Services](../../../../integrate/develop/creating-artifacts/data-services/creating-data-services/#generate-data-service-from-a-datasource).
