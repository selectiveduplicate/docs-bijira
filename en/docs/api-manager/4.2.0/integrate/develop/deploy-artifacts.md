...
Once you have your integration artifacts developed and [packaged in a composite exporter](../../integrate/develop/packaging-artifacts), you can deploy the composite exporter in your Micro Integrator server or your container environment.
...
See the instructions in [using the embedded Micro Integrator](../../integrate/develop/using-embedded-micro-integrator) of WSO2 Integration Studio. 
...
See the instructions in [using a remote Micro Integrator](../../integrate/develop/using-remote-micro-integrator).
...
See the instructions on using the [Docker Exporter](../../integrate/develop/create-docker-project).
...
See the instructions on using the [Kubernetes Exporter](../../integrate/develop/create-kubernetes-project).
