...
!!! Tip
    The `api-operator-ingress` is not created if you have [disabled the ingress controller](../../../../../../install-and-setup/setup/kubernetes-operators/k8s-api-operator/manage-integrations/integration-deployments/#disable-ingress-controller-creation).
