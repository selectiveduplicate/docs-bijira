...
This section describes the data types that are used when defining [Input and Output Mappings](../../../reference/synapse-properties/data-services/query-parameters) in a data service:
