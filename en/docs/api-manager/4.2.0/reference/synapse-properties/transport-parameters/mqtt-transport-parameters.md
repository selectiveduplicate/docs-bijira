...
!!! Info
    The Micro Integrator can communicate through MQTT only if the MQTT transport listener and sender are enabled and configured at the server level. Read about the [MQTT transport](../../../install-and-setup/transport_configurations/configuring-transports/#configuring-the-mqtt-transport).
