...
**Note**: For more information on how this works in an actual scenario, see [Jira Connector Example](../../../reference/connectors/jira-connector/jira-connector-example).
