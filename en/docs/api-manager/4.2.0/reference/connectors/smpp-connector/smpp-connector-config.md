...
```
**Note**: For more information on how this works in an actual scenario, see [SMPP Connector Example](../../../reference/connectors/smpp-connector/smpp-connector-example/).
