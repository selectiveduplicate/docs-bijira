...
The API Manager is built on top of [WSO2 Carbon](https://wso2.com/library/articles/2012/03/carbon-context-its-usages-wso2-products/), an OSGi based components framework for SOA. For more details, see [API Manager components](../getting-started/key-concepts/).
