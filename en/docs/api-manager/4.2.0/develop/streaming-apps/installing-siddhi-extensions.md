...
When you are working with [custom extensions](../../streaming/connectors/writing-custom-siddhi-extensions/), and if you want a custom extension to be installable from the Extension Installer, you need to add the configuration of the extension to this configuration file.
