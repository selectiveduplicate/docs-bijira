...
- [**Siddhi Application Management APIs**](../../develop/streaming-apps/siddhi-application-management-apis)
...
- [**Permission APIs**](../../develop/streaming-apps/permission-apis)
...
- [**Business Rules APIs**](../../develop/streaming-apps/business-rules-apis)
...
- [**Store APIs**](../../develop/streaming-apps/store-apis)

    This category includes a single API that allows you to perform CRUD operations for your data stores.

- [**Healthcheck APIs**](../../develop/streaming-apps/healthcheck-apis)
