...
If you are following the [Deploy API via API-M](../../../../deploy-and-publish/deploy-on-gateway/choreo-connect/deploy-api/deploy-rest-api-in-choreo-connect/) approach, you can add **CORS** configurations for each API using the [WSO2 API-M](../../../../design/advanced-topics/enabling-cors-for-apis/#EnablingCORSPerAPI).
