...
4.  Select the roles you want to assign to the user. In this example, we assign the `creator` role defined in the [previous section](../../administer/managing-users-and-roles/managing-user-roles). For details on adding roles, see [Create user roles](../../administer/managing-users-and-roles/managing-user-roles/#create-user-roles).
