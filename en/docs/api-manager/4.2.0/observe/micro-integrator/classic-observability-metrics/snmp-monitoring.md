...
Following are the OID equivalents of the server manager and transport MBeans, which are described in [JMX Monitoring](../../../observe/micro-integrator/classic-observability-metrics/jmx-monitoring):
