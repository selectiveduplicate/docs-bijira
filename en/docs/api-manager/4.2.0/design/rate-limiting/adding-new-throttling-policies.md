...
4.  Fill in the details required by this form and click **Save** once you are done.
    ...
    !!! note
     ...
     | GraphQL                         | Provide the [maximum complexity](../../design/rate-limiting/graphql-api/query-complexity-limitation/) and [maximum depth values](../../design/rate-limiting/graphql-api/query-depth-limitation/) for GraphQL APIs using this policy.|
