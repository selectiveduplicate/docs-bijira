...
with multiple Gateways. In such scenarios, for [Burst Control](../../..
/design/rate-limiting/setting-throttling-limits/#burst-control) and [Backend Rate Limiting](../../..
...
Once configurations are done, you can follow the docs for [Burst Control](../../..
/design/rate-limiting/setting-throttling-limits/#burst-control) and [Backend Rate Limiting](../../..
