...
!!! note
    You can also revoke refresh tokens. For more information, see [Revoking a refresh token](../../../design/api-security/oauth2/grant-types/refresh-token-grant/#revoking-a-refresh-token).
