...
- [**Cleansing**](../../use-cases/streaming-usecase/cleansing-data)
...
- [**Transforming**](../../use-cases/streaming-usecase/transforming-data)
...
- [**Enriching**](../../use-cases/streaming-usecase/enriching-data)

    Joining streams of data with each other as well as static data (such as tables) to enrich the data
    
- [**Summarizing**](../../use-cases/streaming-usecase/summarizing-data)
...
- [**Correlating**](../../use-cases/streaming-usecase/correlating-data)
