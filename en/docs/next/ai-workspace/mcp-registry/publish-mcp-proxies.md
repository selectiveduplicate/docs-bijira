...
Once you have [configured and deployed an MCP proxy](../mcp-proxies/configure-proxy.md) in the AI Workspace, you can publish it to the MCP Hub. Publishing registers the proxy in your organization's MCP registry, making it discoverable through the MCP Hub and the MCP Registry API.
